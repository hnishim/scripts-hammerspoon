...
struct ClipboardItemSnapshot { let values: [(NSPasteboard.PasteboardType, Data)] }
...
struct ClipboardSnapshot {
    ...
    static func capture(_ pasteboard: NSPasteboard = .general) throws -> ClipboardSnapshot {
        ...
        guard before == pasteboard.changeCount else { throw EngineError.clipboardUnavailable("changed during snapshot") }
...
final class ClipboardTransaction {
    ...
    @discardableResult func restoreIfUntouched() -> Bool {
