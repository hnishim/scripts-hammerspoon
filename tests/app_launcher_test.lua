...
assertTableEqual(hudEvents, {
  ...
  "launch:Arc",
  "show:Command failed.",
}, "failed launch sends both notifications through shared HUD")
assertTableEqual(hudDurations, { 2, 2 }, "failed launch HUD durations")
assertEqual(#alertCalls, 0, "failed launch does not use direct hs.alert")
...
assertTableEqual(hudEvents, {
  ...
  "launch:Missing App",
  "show:Command failed.",
}, "missing app failure sends both notifications through shared HUD")
assertTableEqual(hudDurations, { 2, 2 }, "missing app failure HUD durations")
assertEqual(#alertCalls, 0, "missing app failure does not use direct hs.alert")
